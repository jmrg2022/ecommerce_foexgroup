...
admin.site.site_header = "Administración de FoexGroup"
admin.site.site_title = "Portal de FoexGroup"
admin.site.index_title = "Bienvenidos al portal de administración de FoexGroup"
